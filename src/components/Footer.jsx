    ...
    <div className='bg-black text-[#949494] py-10 px-7 font-titleFont flex flex-row justify-between'>
      <div className=' flex flex-col gap-7'>
        <div className='flex flex-col gap-7'>
          ...
          Dream Nest
          <p className='text-white text-sm tracking-wide'>© dreamnest.com</p>
        ...
        <div className='flex flex-row gap-3'>
          ...
          <FacebookIcon/>
          <TwitterIcon/> */}
          <Link to="https://www.instagram.com/dream_nest_/" target='_blank'><InstagramIcon/></Link>
        </div>
      </div>
      <div className="">
        <h2 className='text-xl text-white 300 mb-3'>Locate Us</h2>
        <p>Bhavsar Street Gandevi</p>
        <p>Instagram: @dream_nest_</p>
